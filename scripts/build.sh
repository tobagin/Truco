...
if [ "$BUILD_TYPE" = "dev" ]; then
    MANIFEST="packaging/io.github.tobagin.Truco.Devel.yml"
    APP_ID="io.github.tobagin.Truco.Devel"
    echo "Building development version..."
else
    MANIFEST="packaging/io.github.tobagin.Truco.yml"
    APP_ID="io.github.tobagin.Truco"
